  ...
  return (
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/manasachitra", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.instagram.com/manasachitra", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/manasa-chitra-995646251/",
              "_blank"
            )
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.facebook.com/manasachitra", "_blank")
          }
        >
